...
<body>
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/bg2.jpeg);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                                        <h1 class="display-4 text-white mb-20">Quality education for your kids</h1>
                            ...
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form action="process.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="nomber" placeholder="Number" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button class="btn btn-warning btn-block" type="submit" name="admin">Login</button>
                                    <p class="font-14 text-center mt-15">Having trouble logging in?</p>
                                    <div class="option-sep">or</div>
                                    <p id="paste" class="alert alert-primary" style="display: none;"></p>
    ...
    <script  src="vendors/jquery/dist/ajas.js"></script>
