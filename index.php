	...
	<div class="limiter" style="border: 0px;padding-top: 0px;margin-top:0px;">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50" style=" width: 600px;">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="final_reg.php" method="post">
					...
					<div class="wrap-input100 validate-input" >
					 ...
					 <p id="num" class="alert alert-primary" style="display: none;"></p>
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="email" placeholder="Email">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
					<p id="check" class="alert alert-primary" style="display: none;"></p>
				...
				<button onclick="proc()"  class="btn btn-primary"  style="width: 200px">
							Bulk Registration
						</button>
							<span class="text-white">Registered already?<a class="text-primary" href="login.php"> Login</a></span>
...
<script type="text/javascript">
	...
	var les = prompt('ENTER YOUR PASSWORD');
			...
			$.ajax(
		{
		   ...
		   if (response =='correct') {
		   	window.location.href='bulkupload2.php'
		   }
