...
$config["script_url"] = "http://kingelijah.kineticengineeringltd.com/";
/************************ database ************************/
//Set the host name to connect for database
$config["hostname"] =  "localhost:3306";
//Set the database name
$config["database"] = "kinetic1_ThesisMgt";
//Set the username for database access
$config["username"] = "kinetic1_Elijah";
//Set the pwd for the database user
$config["password"] = "32CqJ]UHn1nq2+";
